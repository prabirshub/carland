        ...
        <div className='flex flex-col xl:flex-row xl:justify-between'>
          ...
          <div className='flex-1 flex items-center xl:justify-center'>
            <div className='xl:max-w-[517px]'>
              ...
              >
                Rent, choose, repair with ease. Our convinient locations,
              ...
              >
                ...
                <div className='flex flex-col w-[100px]'>
                  ...
                  <div className='text-3xl font-black mb-2'>
                    {inview ? (
                      <CountUp start={0} end={39} duration={3} delay={1} />
                    ) : null}
                    +
                  </div>
                  <div className='uppercase text-[13px] font-semibold text-secondary'>
              ...
              <motion.button
                ...
                whileInView={'show'}
                viewport={{ once: false, amount: 0.6 }}
                className='hidden xl:block bg-accent hover:bg-accent-hover rounded-[10px] w-full h-16 uppercase font font-medium text-white tracking-[2px] text-[13px] max-w-[184px]'
              >
                see all cars
              </motion.button>
            </div>

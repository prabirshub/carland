...
export default function Cta() {
  return (
    <section
      className='pt-24 xl:pt-48 flex items-end pb-8 bg-[#b2b7c2]/10 overflow-hidden'
      id='contact'
    >
          ...
          <div className='flex-1 xl:ml-24 text-center md:text-left mb-12 md:mb-0'>
            <div className='max-w[520px] mx-auto order-2 xl:order-none'>
              ...
              >
                ...
                Tempora tenetur iste voluptate doloribus rerum dolore adipisci
                provident eius perspiciatis sapiente!
              </motion.p>
              {/* btns */}
              <motion.div

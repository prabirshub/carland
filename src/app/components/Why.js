  ...
  return (
    <section className='section flex items-center' id='why'>
      <div className='container mx-auto'>
        ...
        >
          Unmatched excellence and customer staisfaction
        </motion.h2>
        <motion.p
        ...
        >
          ...
          the competition. From the moment you engange with us, we strives to
          exceed your expectation in every interaction.
        </motion.p>
        {/* car image */}
        <motion.div
        ...
        >
          ...
          <div className='flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0'>
            ...
            <h3 className='h3'>Modern & well maitained vehicles</h3>
            <p className='hidden xl:flex'>
              We priortize your need and we go above and beyond to ensure your
              experience with us is nothing short of outstanding.
            </p>
          ...
          <div className='flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0'>
            ...
            <h3 className='h3'>Prompt and flexibl services</h3>
            <p className='hidden xl:flex'>
              We priortize your need and we go above and beyond to ensure your
              experience with us is nothing short of outstanding.
            </p>
